...
for nV in 1:4
    for nH in nV:nV
        for seed in 1:20
            ...
            if nV == 3 && nH == 3 
                max_grad_file = "../Gibbs/gibbsresults/max_gradients/nV_"*string(nV)*"_nH_"*string(nH)*"_seed_"*string(seed)*"_maxgrads.dat"
                max_grad_data = readdlm(max_grad_file,Float64)
            end
            input_file = "../Gibbs/gibbsresults/nV_"*string(nV)*"_nH_"*string(nH)*"_seed_"*string(seed)*"infidelity_vs_params.dat"
            ...
            for i in axes(mydata,1)
                ...
                output_file = "../Gibbs/gibbsresults/csv/twolocal.entangled.twolocal.gibbs."*string(nV)*"."*string(nH)*"."*string(seed)*"."*string(seed)*".csv"
...
#             filename = "../Gibbs/gibbsresults/gradients/nV_"*string(nV)*"_nH_"*string(nH)*"_seed_"*string(seed)*"_pool_grads.dat"
...
# output_file = "../Gibbs/gibbsresults/csv/largest_pool_grad_first_steps.csv"
